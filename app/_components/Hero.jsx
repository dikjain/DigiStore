...
function Hero() {
  return (
    <div className=' p-10 max-[500px]:px-10 px-28 lg:px-36 border-b-2 border-black' >
        <div className='grid grid-cols-1 md:grid-cols-2 gap-10 pt-20'>
            <div>
                <h2 className='text-5xl max-[500px]:text-4xl text-white font-extrabold txt-shadow'>Speed Up your Creative Flow</h2>
            ...
            <div className='flex justify-center items-center'>
                <Image className='scale-x-[-1] img-comp' src='https://digistore-tubeguruji.netlify.app/_next/image?url=%2Fpc2.png&w=384&q=75' alt='Hero'  height={300} width={300} />
            </div>
